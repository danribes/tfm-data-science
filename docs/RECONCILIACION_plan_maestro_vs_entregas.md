...
**→ RESUELTO (2026-07-18):** decisión del autor: raíz = programa. La transición se explica de frente en [entregas/anexo_transicion_proyecto.md](entregas/anexo_transicion_proyecto.md) (respuesta al feedback + qué se conserva de vivienda + validación pendiente §6) y el [README](../README.md) la señala desde la portada.
