...
MC_FB_DN = 0.005       # asymmetric loosening when debt runs below it
...
CONSTANTS_TABLE: list[dict] = [
    ...
    {"name": "IPV_LR", "value": IPV_LR, "unit": "% a/a", "provenance": _EST + " · crecimiento medio anual del IPV (Índice de Precios de Vivienda del INE), 17 CCAA + Ceuta y Melilla; Nacional excluido; banda condicional a la muestra"},
    ...
    {"name": "E_IPV_R", "value": E_IPV_R, "unit": "pp de IPV por pp de Euríbor", "provenance": _V16 + " · cuánto frena un punto más de Euríbor la subida anual del precio de la vivienda (IPV)"},
    {"name": "E_IPV_G", "value": E_IPV_G, "unit": "pp de IPV por pp de crecimiento del PIB", "provenance": _V16 + " · cuánto empuja un punto más de crecimiento la subida anual del precio de la vivienda (IPV)"},
