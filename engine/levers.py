...
LEVER_SPECS: list[dict] = [
    {"id": "r", "sym": "r", "nm": "Tipo de interés · Euríbor 12m", "unit": "%",
     "plain": "Lo que cuesta pedir dinero prestado en Europa. Si sube, se encarecen las hipotecas y también la deuda del Estado.",
     "min": 0.0, "max": 6.0, "step": 0.05, "dec": 2, "src": "ecb_euribor12m.csv · 2026-06"},
    {"id": "prima", "sym": "σ", "nm": "Prima de riesgo · spread ES–DE", "unit": "pb",
     "plain": "El sobrecoste que paga España frente a Alemania por pedir prestado. Mide la desconfianza de quien presta.",
    ...
    {"id": "sp", "sym": "sp", "nm": "Saldo primario · Δ vs central", "unit": "pp PIB",
     "plain": "Lo que el Estado ingresa menos lo que gasta, sin contar los intereses de la deuda. Positivo es superávit; negativo, déficit.",
     "min": -4.0, "max": 4.0, "step": 0.1, "dec": 1, "src": "gold_escenarios_deuda.csv (central)"},
    {"id": "lam", "sym": "λ", "nm": "Productividad", "unit": "%/año",
     "plain": "Cuánto se produce por hora trabajada. Es lo que permite subir sueldos sin que suban los precios.",
     "min": -0.5, "max": 2.5, "step": 0.1, "dec": 1, "src": "PWT + INE · desplaza la PS"},
    {"id": "pm", "sym": "pᵐ", "nm": "Precio importaciones/energía", "unit": "% a/a",
     "plain": "Lo que cuesta lo que compramos fuera, sobre todo energía. Si se encarece, acaba en los precios de aquí.",
     "min": -50.0, "max": 100.0, "step": 5.0, "dec": 0, "src": "WEO commodity prices"},
    {"id": "tau", "sym": "τ", "nm": "Presión fiscal · cuña laboral", "unit": "pp",
     "plain": "La diferencia entre lo que le cuesta un empleado a la empresa y lo que él cobra: impuestos y cotizaciones.",
     "min": -5.0, "max": 5.0, "step": 0.25, "dec": 2, "src": "Eurostat GFS · desplaza la WS"},
    {"id": "z", "sym": "z", "nm": "Instituciones laborales", "unit": "índice",
     "plain": "Cuánto protege y negocia el empleo el marco laboral: convenios, indemnizaciones, salario mínimo.",
     "min": -2.0, "max": 2.0, "step": 0.1, "dec": 1, "src": "OECD/Eurostat · desplaza la WS"},
    {"id": "ext", "sym": "Y*", "nm": "Demanda externa", "unit": "% a/a",
     "plain": "Cuánto crecen los países que nos compran. Si a ellos les va bien, aquí se exporta más.",
     "min": -4.0, "max": 6.0, "step": 0.1, "dec": 1, "src": "WEO · canal exterior (U7)"},
    {"id": "dem", "sym": "β₆₅", "nm": "Presión demográfica", "unit": "×",
     "plain": "Cuántas personas mayores hay por cada persona en edad de trabajar.",
    ...
    {"id": "idx", "sym": "ι", "nm": "Indexación pensiones/nóminas", "unit": "IPC+pp",
     "plain": "Cuánto suben las pensiones y las nóminas cada año por encima o por debajo de la inflación.",
