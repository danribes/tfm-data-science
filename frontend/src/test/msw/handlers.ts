...
export const handlers = [
    ...
    HttpResponse.json({
      ...
      comparisons: [
        { constant: "IPV_LR", label: "Crecimiento medio del IPV en la muestra regional",
          ...
          n: 1387, n_units: 19, ci_low: 0.90, ci_high: 1.53, significant: true,
          subperiods: [
            { label: "2007–2013 · ajuste", name: "2007–2013 · ajuste",
              coef: -6.45, se: 0.37, n: 456, n_units: 19,
              ci_low: -7.06, ci_high: -5.84, significant: true },
      ...
      irf: {
        anchor_h: 4,
        engine_reversion: 0.2039,
        unit: "puntos logarítmicos de cambio acumulado por pp de crecimiento previo",
        note: "asociación entre crecimiento previo y cambio futuro regional",
        comparison_note: "Comparación descriptiva normalizada al primer año, sin identificación causal; sólo puntos anuales.",
        horizons: [
          { h: 0, years: 0, name: "h=0", coef: 0, se: 0, n: 1387, n_units: 19,
            ci_low: 0, ci_high: 0, significant: false },
          { h: 4, years: 1, name: "h=4", coef: 0.339, se: 0.054, n: 1311, n_units: 19,
            ci_low: 0.251, ci_high: 0.428, significant: true },
          { h: 8, years: 2, name: "h=8", coef: 0.477, se: 0.087, n: 1235, n_units: 19,
            ci_low: 0.334, ci_high: 0.620, significant: true },
          { h: 12, years: 3, name: "h=12", coef: 0.562, se: 0.126, n: 1159, n_units: 19,
            ci_low: 0.355, ci_high: 0.769, significant: true },
        ],
        engine_path: [
          { h: 0, years: 0, coef: 0 },
          { h: 4, years: 1, coef: 0.339 },
          { h: 8, years: 2, coef: 0.610 },
          { h: 12, years: 3, coef: 0.825 },
        ],
      },
      fiscal_persistence: {
  ...
  http.get(`${BASE}/rag/collections`, () =>
    HttpResponse.json({
      ...META,
      collections: [
        { id: "libros", label: "Economía y métodos", authority: "academico",
          note: "Documentos e índice locales; los pasajes seleccionados se envían al proveedor de IA configurado.",
