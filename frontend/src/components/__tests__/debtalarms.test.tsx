...
const DEFS = [
  ...
  { id: "deficit_suelo_2009", label: "Déficit > 11,3 % PIB", series: "saldo", threshold: -11.3, cmp: "lt", source: "suelo 2009 [hist]" },
...
describe("DebtAlarms — ¿cuándo es demasiada deuda?", () => {
  ...
  it("gives the year each alarm goes off in the base scenario", () => {
    ...
    expect(whenOf("Déficit > 11,3 % PIB")).toBe("salta en 2043");
  ...
  it("moves with the levers: more productivity switches alarms off", () => {
    ...
    expect(whenOf("Déficit > 11,3 % PIB")).toBe("no salta antes de 2050");
